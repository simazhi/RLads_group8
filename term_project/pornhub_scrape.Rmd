...
# **This is the base script in Rmd which was cut up into R files that were fed to a server for data gathering. Run those files instead for maximal reprocubility**
